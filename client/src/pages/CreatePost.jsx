    ...
    return(
        <div>
            ...
            <div className="px-6 md:px-[200px] mt-8">
                <h1 className="font-bold md:text-2xl text-xl mt-8 text-indigo-800">Create a Post</h1>
                <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4">
                    <input onChange={(e)=>setTitle(e.target.value)} type="text" placeholder="Enter post Title" className="px-4 py-2 border-2 border-coral-700 outline-0"/>
                    ...
                    <button onClick={handleCreate} className="bg-coral-700 w-full md:w-[20%] rounded-lg mx-auto text-black font-semibold px-4 py-2 md:text-xl text-lg ">CREATE</button>
                </form>
            </div>
            <Footer/>
        </div>
